...
const businessVerificationSchema = new mongoose.Schema(
  {
    ...
    incorporationNumber: { type: String, trim: true, maxlength: 80, default: "", select: false },
    incorporationNumberEncrypted: { type: String, default: "", select: false },
    incorporationNumberMasked: { type: String, default: "" },
